...
export class TeamService {
  ...
  teamServiceArray: TeamModel[] = [
    ...
    new TeamModel(
      ...
      'Surrey, England',
      'assets/images/mclaren-team.png',
    ...
    new TeamModel(
      ...
      'VF-21',
      'Guenther Steiner',
      ['Mick Schumacher', ' Kevin Magnessen'],
      'North Carolina, USA',
      'assets/images/haas-team.jpg',
      'Ferrari 065/6',
      0,
      0,
      '2016 Australia'
